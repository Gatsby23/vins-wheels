...
class IMUFactor_origin : public ceres::SizedCostFunction<15, 7, 9, 7, 9>
{
  public:
    IMUFactor_origin() = delete;
    IMUFactor_origin(IntegrationBase* _pre_integration):pre_integration(_pre_integration)
    {
    }
...
//delta_q = Qi.inverse() * Qj;
        ...
        Eigen::Matrix<double, 15, 15> sqrt_info = Eigen::LLT<Eigen::Matrix<double, 15, 15>>(pre_integration->covariance_origin.inverse()).matrixL().transpose();
//        std::cout<<"sqrt_info\n"<<setprecision(6)<<sqrt_info<<std::endl;
